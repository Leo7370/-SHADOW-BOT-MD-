...
let handler = async (m, { conn, text, isOwner }) => {
    if (!text) return m.reply('🍬 Debes enviar una invitacion para que *Shadow - Bot* se una al grupo.');
    ...
    if (isOwner) {
        ...
        await conn.sendMessage('526633900512' + '@s.whatsapp.net', { text: message, mentions: [m.sender] }, { quoted: m });
